    ...
    <div className="flex flex-col md:flex-row-reverse  md:w-[88%] md:self-center py-8">
      ...
      <div className="flex flex-col gap-4 border-2 border-red-600 p-4 md:w-[75vw]">
        ...
        <p className="text-paragraphMob md:text-paragraphDesk italic">
          ...
          dolor voluptas doloribus, iusto ducimus quidem nam! Harum eum
          accusamus itaque ipsam, fugit architecto nesciunt consequatur libero
          quam soluta natus pariatur dignissimos.
        </p>
